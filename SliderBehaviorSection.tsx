...
interface SliderBehaviorSectionProps {
    ...
    handleSliderSpeedBlur: () => void;
    spaceBetween: number;
    handleSpaceBetweenChange: (value: string) => void;
    handleSpaceBetweenBlur: () => void;
...
export const SliderBehaviorSection = (props: SliderBehaviorSectionProps) => {
    const {
        ...
        sliderSpeed, handleSliderSpeedChange, handleSliderSpeedBlur,
        spaceBetween, handleSpaceBetweenChange, handleSpaceBetweenBlur,
            ...
            <InlineGrid columns={{ xs: '1fr', md: '1fr 2fr' }} gap="600" alignItems="start">
                ...
                <Card padding="400">
                    <BlockStack gap="400">
                        ...
                        <InlineGrid columns={{ xs: '1fr', sm: '1fr 1fr' }} gap="400">
                            <TextField label="Autoplay Speed" value={sliderSpeed === 0 ? '' : String(sliderSpeed)} onChange={handleSliderSpeedChange} onBlur={handleSliderSpeedBlur} type="number" min={2000} max={12000} step={1000} helpText="Time between slides (2000-12000 milliseconds)" autoComplete="off" suffix="ms" />
                            <TextField label="Space Between" value={spaceBetween === 0 ? '' : String(spaceBetween)} onChange={handleSpaceBetweenChange} onBlur={handleSpaceBetweenBlur} type="number" min={0} max={100} helpText="Space between slides (0-100px)" autoComplete="off" suffix="px" />
                        </InlineGrid>
