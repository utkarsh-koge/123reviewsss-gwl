...
interface TextStylingSectionProps {
    ...
    handleHeadingFontSizeBlur: () => void;
    ...
    handleHeadingLetterSpacingBlur: () => void;
    headingLineHeight: number;
    handleHeadingLineHeightChange: (value: string) => void;
    handleHeadingLineHeightBlur: () => void;
    ...
    handleRatingLabelFontSizeBlur: () => void;
    ...
    handleRatingValueFontSizeBlur: () => void;
    ...
    handleReviewCountFontSizeBlur: () => void;
...
export const TextStylingSection = (props: TextStylingSectionProps) => {
    const {
        ...
        headingFontSize, handleHeadingFontSizeChange, handleHeadingFontSizeBlur, headingFontWeight, setHeadingFontWeight,
        headingFontStyle, setHeadingFontStyle, headingTextTransform, setHeadingTextTransform,
        headingLetterSpacing, handleHeadingLetterSpacingChange, handleHeadingLetterSpacingBlur, headingLineHeight, handleHeadingLineHeightChange, handleHeadingLineHeightBlur,
        headingTextShadow, setHeadingTextShadow,
        ratingLabelText, setRatingLabelText, ratingLabelFontFamily, setRatingLabelFontFamily,
        ratingLabelFontSize, handleRatingLabelFontSizeChange, handleRatingLabelFontSizeBlur, ratingLabelFontWeight, setRatingLabelFontWeight,
        ratingLabelColor, handleRatingLabelColorChange,
        ratingValueFontFamily, setRatingValueFontFamily, ratingValueFontSize, handleRatingValueFontSizeChange, handleRatingValueFontSizeBlur,
        ...
        reviewCountFontFamily, setReviewCountFontFamily, reviewCountFontSize, handleReviewCountFontSizeChange, handleReviewCountFontSizeBlur,
                ...
                <Card padding="400">
                    <BlockStack gap="500">
                        ...
                        <InlineGrid columns={{ xs: '1fr', sm: '1fr 1fr 1fr' }} gap="400">
                            <TextField label="Font Size" value={headingFontSize === 0 ? '' : String(headingFontSize)} onChange={handleHeadingFontSizeChange} onBlur={handleHeadingFontSizeBlur} type="number" min={1} max={50} helpText="Font size in pixels (max 50px)" autoComplete="off" suffix="px" />
                        ...
                        <InlineGrid columns={{ xs: '1fr', sm: '1fr 1fr 1fr' }} gap="400">
                            ...
                            <TextField label="Letter Spacing" value={headingLetterSpacing === 0 ? '' : String(headingLetterSpacing)} onChange={handleHeadingLetterSpacingChange} onBlur={handleHeadingLetterSpacingBlur} type="number" min={-10} max={50} helpText="Space between letters in pixels (-10 to 50px)" autoComplete="off" suffix="px" />
                            <TextField label="Line Height" value={headingLineHeight === 0 ? '' : String(headingLineHeight)} onChange={handleHeadingLineHeightChange} onBlur={handleHeadingLineHeightBlur} type="number" min={0.5} max={3} step={0.1} helpText="Line height multiplier (0.5 to 3)" autoComplete="off" />
                        </InlineGrid>
                        ...
                        <InlineGrid columns={{ xs: '1fr', sm: '1fr 1fr 1fr' }} gap="400">
                            <TextField label="Font Size" value={ratingLabelFontSize === 0 ? '' : String(ratingLabelFontSize)} onChange={handleRatingLabelFontSizeChange} onBlur={handleRatingLabelFontSizeBlur} type="number" min={1} max={50} helpText="Font size in pixels (max 50px)" autoComplete="off" suffix="px" />
                        ...
                        <InlineGrid columns={{ xs: '1fr', sm: '1fr 1fr 1fr' }} gap="400">
                            ...
                            <TextField label="Font Size" value={ratingValueFontSize === 0 ? '' : String(ratingValueFontSize)} onChange={handleRatingValueFontSizeChange} onBlur={handleRatingValueFontSizeBlur} type="number" min={1} max={50} helpText="Font size in pixels (max 50px)" autoComplete="off" suffix="px" />
                        ...
                        <InlineGrid columns={{ xs: '1fr', sm: '1fr 1fr 1fr' }} gap="400">
                            ...
                            <TextField label="Font Size" value={reviewCountFontSize === 0 ? '' : String(reviewCountFontSize)} onChange={handleReviewCountFontSizeChange} onBlur={handleReviewCountFontSizeBlur} type="number" min={1} max={50} helpText="Font size in pixels (max 50px)" autoComplete="off" suffix="px" />
