...
export default function SettingsPage() {
  const {
    ...
    handleHeadingLineHeightChange, handleHeadingLineHeightBlur, handleRatingLabelFontSizeChange, handleRatingLabelFontSizeBlur,
    handleRatingValueFontSizeChange, handleRatingValueFontSizeBlur, handleReviewCountFontSizeChange, handleReviewCountFontSizeBlur,
          ...
          <Layout.Section>
            <BlockStack gap="500">
              <TextStylingSection
                ...
                handleHeadingFontSizeBlur={handleHeadingFontSizeBlur}
                ...
                handleHeadingLetterSpacingBlur={handleHeadingLetterSpacingBlur}
                headingLineHeight={headingLineHeight}
                handleHeadingLineHeightChange={handleHeadingLineHeightChange}
                handleHeadingLineHeightBlur={handleHeadingLineHeightBlur}
                ...
                handleRatingLabelFontSizeBlur={handleRatingLabelFontSizeBlur}
                ...
                handleRatingValueFontSizeBlur={handleRatingValueFontSizeBlur}
                ...
                handleReviewCountFontSizeBlur={handleReviewCountFontSizeBlur}
              ...
              {displayType === 'slider' && (
                <>
                  ...
                  <SliderBehaviorSection
                    ...
                    handleSliderSpeedBlur={handleSliderSpeedBlur}
                    spaceBetween={spaceBetween}
                    handleSpaceBetweenChange={handleSpaceBetweenChange}
                    handleSpaceBetweenBlur={handleSpaceBetweenBlur}
